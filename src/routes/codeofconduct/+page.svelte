<script>
	...
	channel.addMessage({
		author: 'hazycora',
		content: 'rule #3 if anyone suddenly dies under weird circumstances hazy didnt do anything hazy isnt involved please dont tell anyone that hazys a suspect hazy didnt do anything',
		time: 1666060490630
	})
	channel.addMessage({
		author: 'aria',
