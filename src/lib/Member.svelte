            ...
            <p class="member-socials">
                {#if member.socials.twitter}
                    <a href="https://twitter.com/intent/user?user_id={member.socials?.twitter}">
                        <svg class="member-social-icon" aria-label="Twitter" role="img" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 248 204">
                ...
                {#if member.socials.mastodon}
                    <a href="{member.socials.mastodon}">
                        <svg class="member-social-icon" aria-label="Mastodon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 216.4144 232.00976">
                            <mask id="m-mask">
                ...
                {#if member.socials.github}
                    <a href="https://github.com/{member.socials.github}">
                        <svg class="member-social-icon" aria-label="GitHub" role="img" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="1.4 1.4 33.2 33.2" enable-background="new 0 0 36 36" xml:space="preserve">
